<x-guest-layout>
    <div class="text-center mb-8">
        <div class="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-emerald-500/20 to-green-500/20 mb-5 ring-1 ring-white/10">
        ...
        <p class="text-sm text-slate-400 mt-2">Enter your new password</p>
    </div>
    ...
    <form method="POST" action="{{ route('password.store') }}" class="space-y-5">
        ...
        <div class="space-y-1.5">
            ...
            <div class="relative">
                ...
                <input id="email" class="input-field !pl-10" type="email" name="email" :value="old('email', $request->email)" required autofocus autocomplete="username" placeholder="name@example.com">
            </div>
